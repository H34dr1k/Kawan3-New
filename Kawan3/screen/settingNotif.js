...
class settingNotif extends React.Component {
    ...
    adjustSettings(){
        ...
        if(datauser.setting.notifikasiDariTeman == 1 && datauser.setting.notifikasi == 1){
            this.setState({switchValue2: true});
        }

        if(datauser.setting.notifikasiDariOrangTerdekat == 1 && datauser.setting.notifikasi == 1){
    ...
    saveSetting(){
        ...
        dataBaru.notifikasi = this.state.switchValue1;
        dataBaru.notifikasiDariTeman = this.state.switchValue2;
        dataBaru.notifikasiDariOrangTerdekat = this.state.switchValue3;
        dataBaru.postinganDariTeman = this.state.switchValue4;
        dataBaru.postinganDariOrangTerdekat = this.state.switchValue5;
