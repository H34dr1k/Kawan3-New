...
class createComm2 extends React.Component {
    ...
    _onPressButton() {
        ...
        Alert.alert('Create Community Success')
        ...
        return(
            <View style={{flex: 1, backgroundColor: '#EFEEEE'}}>
                <View style={{borderBottomLeftRadius: 20, borderBottomRightRadius: 20, flex: 0,flexDirection: 'row', height: 102, width: '100%', backgroundColor: '#628DE7', paddingTop: 26.5}}>
                    <TouchableOpacity onPress={()=> this.props.navigation.navigate('createComm')}>
                ...
                <View style={{marginHorizontal: 26}}>
                    ...
                    <ImageBackground source={require('../src/image/decoStar.png')} style={{width: '95%', height: '100%'}}>
                        <Text style={{fontSize: 18, color: 'white', textAlign: 'center', marginTop: 15}}>Create my Community</Text>
                    </ImageBackground>
                    </TouchableOpacity>
                </View>
            </View>
